...
/* A reusable component for displaying code with syntax highlighting and also it is used accross all the ai features */
const CodeDisplayBlock = ({ 
  ...
  //this use effect is used to when the language or code changes, it will highlight the code
  useEffect(() => {
    if (!code) return;
  ...
  return (
    <div className="relative">
      ...
      <div 
        className={`bg-neutral-800/80 rounded-b-lg p-4 text-sm text-neutral-100 whitespace-pre-wrap max-h-${maxHeight} overflow-y-auto border border-neutral-700/50 shadow-inner`}
